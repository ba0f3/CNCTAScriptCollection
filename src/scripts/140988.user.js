  ...
  var CCTAWrapper_main = function () {
    ...
    wrapper = {
       _val_or_def: function(val, def) {
        ...
        wraps: [
            [0, 'System', 'EventHandler', ['VTJBRR', 556, 'AFADHT', 543]],
			[1, 'System.EventHandler', '$ctor', ['UTJPOT', 1, 'UOZTQY', 1]],
			[1, 'ClientLib.Vis.ViewModeChange', '$ctor', ['UTJPOT', 1, 'UOZTQY', 1]],
            [0, 'SharedLib', 'Combat', ['CJLCVL', 519, 'NOOXEE', 503]],
            [0, 'SharedLib.Combat', 'CbtSetup', ['HIWRPX', 550, 'IIFAVI', 537], 'SharedLib'],
            [0, 'SharedLib.Combat', 'CbtSimulation', ['HGWILL', 553, 'UYGNWU', 540], 'SharedLib'],
			[2, 'ClientLib.Vis.Battleground.Battleground', 'get_Entities', ['ECZKLY', 32, 'XRJAVF', 34]],
			[1, 'SharedLib.Combat.CbtSimulation', 'DoStep', ['AXYNEQ', 26, 'JTYQVH', 26]],
			[2, 'SharedLib.Combat.CbtSimulation', 'get_iCombatStep', ['ZMGJIP', 13,  'BMCNPQ', 13]],
            [0, 'SharedLib.Combat', 'CbtEntity', ['OPOFMB', 558, 'IIAZTQ', 545], 'SharedLib'],
            ...
            [0, 'ClientLib.Data', 'World', ['UHPQFY', 238, 'CVSXEK', 231], 'SharedLib'],
            ...
            [0, 'ClientLib.Data', 'CityRepair', ['BOIFDD', 323, 'FQDPEX', 312], 'SharedLib'],
			[1, 'ClientLib.Data.CityRepair', 'CanRepair', ['ZUSBPX', 53, 'AUFSAM', 53]],
            ...
            [0, 'ClientLib.Vis.Battleground', 'BattlegroundEntity', ['IIYEQI', 557, 'MGYGBY', 544], 'System'],
